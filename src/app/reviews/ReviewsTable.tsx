...
export default function ReviewsTable() {
  ...
  const getTagLabel = useCallback((tag: string): string => TAG_LABELS[tag as keyof typeof TAG_LABELS] || tag, [])
  ...
  const RatingStar = () => <Image src="/static/star.gif" alt="Star" width={20} height={20} className="mr-2" />
          ...
          <AccordionTrigger className="px-4 py-6">
            {showCredit ? (
              <div className="flex w-full">
                {credit}
                <span className="ml-auto mr-4 flex justify-end text-muted-foreground lg:mr-12">
                  {perfectScores > 0 && (
                    <>
