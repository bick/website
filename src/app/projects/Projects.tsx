...
export default function ProjectsPage() {
  return (
    <>
      <Hero title="🚀 Projects" subtitle="A selection of work I've led, built, or shipped." gradient="orange" />
              ...
              >
                ...
                >
                  ...
                  <div className="flex w-full flex-col justify-center p-8 md:w-1/2 md:p-12">
                    ...
                    <p className="mt-4 text-base leading-relaxed opacity-60">{project.summary}</p>
                    ...
                    <div className="mt-8">
                      <span className="text-sm font-medium text-orange-400 underline decoration-orange-400/30 underline-offset-4 transition-colors group-hover:text-orange-300 group-hover:decoration-orange-300">
