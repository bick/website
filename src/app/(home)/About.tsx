  ...
  return (
    <section className="about my-12 text-lg">
      <div className="container">
        <h2>😺 About Me</h2>
        <p className="mt-4">
          I&apos;m Owen, I&apos;m a software engineer that currently lives in
          Austin.
        </p>
        <p>
          ...
          Series C or higher rounds helping them develop cutting-edge digital
          products, secure funding, and scale their engineering and product
          teams.
        </p>
      </div>
    </section>
